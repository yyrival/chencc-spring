package com.chencc.spring.framework.servlet;

import com.chencc.spring.framework.annotation.*;
...
public class CCDispatcherServlet extends HttpServlet{
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("CC Spring framework is init.");
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(CCController.class)){continue;}


            //保存写在类上面的@CCRequestMapping("/demo")
            String baseUrl = "";
        ...
        private void putParamIndexMapping(Method method){
            ...
            for (int i = 0; i < pa.length ; i ++) {
                for(Annotation a : pa[i]){
                    if(a instanceof CCRequestParam){
                        String paramName = ((CCRequestParam) a).value();
